...
- OpenRouter provider pinning for GLM-5.2 and region-specific Kimi K3 routes.
...
| Kimi K3 (PRC) | `moonshotai/kimi-k3` | OpenRouter | Moonshot AI |
| Kimi K3 (US) | `moonshotai/kimi-k3` | OpenRouter | Together |
